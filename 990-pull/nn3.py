...
#-----------------------------------------------------------------------        
        ...
        ''' The in in dropped list was not breaking as expected.  Need to think through the loop in a different way
  ...
  # breaking out dict return from the 990
            ...
            with open('none-list.csv','a') as f:
                f.write('Looking and did not find %s , year %s\n'%(org_to_search,str(year)))
